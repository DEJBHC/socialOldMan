...
public class PatientInfoController extends BaseController {
    ...
    public Object list(String condition) {
        ...
        if (ShiroKit.isUsers()) {
            ...
            patientInfos = patientInfoService.selectpatientInfoList(user.getCardid());
        } else {
            patientInfos= patientInfoService.selectList(null);
        }
        System.out.println("11111111111111111111111111111");
        System.out.println(patientInfos.get(0));
        return patientInfos;
    }
