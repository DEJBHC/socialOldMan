...
PatientHealth.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '', field: 'date', visible: true, align: 'center', valign: 'middle',sortable: true},
...
PatientHealth.resetSearch = function () {
    $("#id").val("");
    $("#beginTime").val("");
    $("#endTime").val("");

    PatientHealth.search();
}

PatientHealth.search = function () {
    var queryData = {};

    queryData['id'] = PatientHealth.id;
